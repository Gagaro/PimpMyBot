...
from .custom_commands import Command, Action, CommandAction
...
@jinja2_view('custom_commands/settings')
...
@route('/custom_commands/add', name='custom_commands:add_command')
@jinja2_view('custom_commands/command_add_form')
...
@route('/custom_commands/action_input', name='custom_commands:action_input')
@jinja2_view('custom_commands/action_input')
def custom_commands_action_input():
    return {}
